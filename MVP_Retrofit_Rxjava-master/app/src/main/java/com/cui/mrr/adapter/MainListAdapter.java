...
public class MainListAdapter extends RecyclerView.Adapter<MainListAdapter.Viewholder> {
    ...
    public void onBindViewHolder(Viewholder holder, int position) {
       Glide.with(mContext).load("http://119.29.96.105:8080/DriveSchoolBackStage/"+list.get(position).getNewimages()).into(holder.img);
    }
    ...
    public void setNewData(List<ListEntity> list) {
        this.list.clear();
